...
<div class="row gy-4">
        ...
        <div class="card h-100 p-0">
            ...
            <div class="card-body p-24 text-center d-flex flex-wrap align-items-start gap-5 justify-content-center">
                <div class="position-relative">
                    <div id="basicDonutChart" class="w-auto d-inline-block"></div>
    ...
    <div class="col-md-6">
        <div class="card h-100 p-0">
            ...
            <div class="card-body p-24 text-center">
                <div id="multipleSeriesChart" class="square-marker check-marker series-gap-24 d-flex justify-content-center"></div>
            </div>
        </div>
    </div>
</div>
