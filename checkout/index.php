        ...
        <div class="row">
            <div class="col-12">
                <form action="#" class="woocommerce-form-login mb-30">
                    ...
                    <div class="form-group">
                        <button type="submit" class="th-btn rounded-2">Login</button>
        ...
        <div class="row">
            <div class="col-12">
                <form action="#" class="woocommerce-form-coupon">
                    ...
                    <div class="form-group">
                        <button type="submit" class="th-btn rounded-2">Apply coupon</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="mt-lg-3 mb-30">
            <div class="woocommerce-checkout-payment">
                ...
                <div class="form-row place-order">
                    <button type="submit" class="th-btn rounded-2">Place order</button>
                </div>
            </div>
        </div>
    </div>
