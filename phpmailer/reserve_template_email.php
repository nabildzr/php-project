...
try {
    ...
    $mail->setFrom('nabildzr@gmail.com', 'Message from Foores');                    // Email Address and Name FROM
    $mail->addAddress('nabildzr@gmail.com', 'Jhon Doe');                            // Email Address and Name TO - Name is optional
    $mail->addReplyTo('nabildzr@gmail.com', 'Message from Foores');              // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
