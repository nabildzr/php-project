...
try {
    ...
    $mail->Username   = 'rezafakuna@gmail.com';                             // SMTP username
    $mail->Password   = 'Habipa3321';                             // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 465;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients - main edits
    $mail->setFrom('nabildzikrika@gmail.com', 'Message from Foores');                    // Email Address and Name FROM
    $mail->addAddress('nabildzikrika@gmail.com', 'Jhon Doe');                            // Email Address and Name TO - Name is optional
    $mail->addReplyTo('nabildzikrika@gmail.com', 'Message from Foores');              // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
