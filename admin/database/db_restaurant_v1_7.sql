...
--
-- Host: localhost:3306
-- Generation Time: Nov 11, 2024 at 10:31 AM
...
CREATE TABLE `card_payments` (
  ...
  `expiry_date` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `security_code` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('', 'Drig', 'Chicken Pizza', 'Main Dishes', '125000.0000', 'Another tasty', '67319d125af58.png', 0, '25.00'),
('BBQ01', 'Vegetarian', 'Beef Barbeque', 'Main Dishes', '250000.0000', 'Cuisine Meal Health Food', '671db7ed5eb18.png', 1, '24.00'),
...
('SFA2', 'Stack', 'Beef Burger', 'Main Dishes', '205555.0000', '', '6731a867b081c.png', 0, '25.00'),
('SKS2', 'Bin', 'Beef Barbeque', 'Main Dishes', '205555.0000', '', '6731a8d65e1c9.jpg', 0, '25.00'),
('SWA01', 'Grim', 'Beef Burger', 'Main Dishes', '500000.0000', 'Another tasty', '67319e5cdf947.jpeg', 0, '99.00');
...
CREATE TABLE `menu_description` (
  ...
  `ingredients` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `menu_description` (`item_description_id`, `item_id`, `calories`, `Protein`, `carboidrates`, `fat`, `weight`, `ingredients`, `halal`) VALUES
(1, 'BBQ01', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'P01', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'P03', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'PS01', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'PS02', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'SFA2', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'SKS2', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 'SWA01', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `menu_sales` (
  `sale_id` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `item_id` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `staff` (
  ...
  `account_id` int NOT NULL,
  `staff_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE;
