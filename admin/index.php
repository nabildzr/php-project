<?php
include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/template/header.php');
?>
              ...
              <div class="row">
                <div class="col-12 col-sm-7">
                  <div class="d-flex align-items-center gap-3 mb-5">
                    <img src="/admin/assets/images/avatars/01.png" class="rounded-circle bg-grd-info p-1" width="60"
                      height="60" alt="user">
                    <div class="">
              ...
              <div class="d-flex flex-column justify-content-between gap-4">
                <div class="d-flex align-items-center gap-4">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="/admin/assets/images/apps/17.png" width="32" alt="">
                ...
                <div class="d-flex align-items-center gap-4">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="/admin/assets/images/apps/18.png" width="32" alt="">
                ...
                <div class="d-flex align-items-center gap-4">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="/admin/assets/images/apps/19.png" width="32" alt="">
                ...
                <div class="d-flex align-items-center gap-4">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="/admin/assets/images/apps/20.png" width="32" alt="">
                ...
                <div class="d-flex align-items-center gap-4">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="/admin/assets/images/apps/05.png" width="32" alt="">
                ...
                <div class="d-flex align-items-center gap-4">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="/admin/assets/images/apps/08.png" width="32" alt="">
                ...
                <div class="d-flex align-items-center gap-4">
                  <div class="d-flex align-items-center gap-3 flex-grow-1">
                    <img src="/admin/assets/images/apps/07.png" width="32" alt="">
          ...
          <div class="card w-100 rounded-4">
            ...
            <div class="card-body p-0">
              <div class="user-list p-3">
                <div class="d-flex flex-column gap-3">
                  <div class="d-flex align-items-center gap-3">
                    <img src="/admin/assets/images/avatars/01.png" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="/admin/assets/images/avatars/02.png" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="/admin/assets/images/avatars/03.png" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="/admin/assets/images/avatars/04.png" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="/admin/assets/images/avatars/05.png" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="/admin/assets/images/avatars/06.png" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img src="/admin/assets/images/avatars/08.png" width="45" height="45" class="rounded-circle" alt="">
                    <div class="flex-grow-1">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="">
                            <img src="/admin/assets/images/top-products/01.png" class="rounded-circle" width="50" height="50"
                              alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="">
                            <img src="/admin/assets/images/top-products/02.png" class="rounded-circle" width="50" height="50"
                              alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="">
                            <img src="/admin/assets/images/top-products/03.png" class="rounded-circle" width="50" height="50"
                              alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="">
                            <img src="/admin/assets/images/top-products/04.png" class="rounded-circle" width="50" height="50"
                              alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center gap-3">
                          <div class="">
                            <img src="/admin/assets/images/top-products/06.png" class="rounded-circle" width="50" height="50"
                              alt="">
                          </div>
    ...
    <div class="offcanvas-body p-0">
      <div class="order-list">
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/01.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
        ...
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/02.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
          <div class="order-info flex-grow-1">
        ...
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/03.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
          <div class="order-info flex-grow-1">
        ...
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/04.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
          <div class="order-info flex-grow-1">
        ...
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/05.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
          <div class="order-info flex-grow-1">
        ...
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/06.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
          <div class="order-info flex-grow-1">
        ...
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/07.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
          <div class="order-info flex-grow-1">
        ...
        <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
          <div class="order-img">
            <img src="/admin/assets/images/orders/08.png" class="img-fluid rounded-3" width="75" alt="">
          </div>
          <div class="order-info flex-grow-1">
...
<?php
include_once($_SERVER['DOCUMENT_ROOT'] . '/admin/template/footer.php');
?>